...
const file_api_v1_ai_service_proto_rawDesc = "" +
	"\n" +
	"\x17api/v1/ai_service.proto\x12\fmemos.api.v1\x1a\x1cgoogle/api/annotations.proto\"'\n" +
	"\vChatRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"*\n" +
	"\fChatResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\tR\bresponse2f\n" +
	"\tAiService\x12Y\n" +
	"\x04Chat\x12\x19.memos.api.v1.ChatRequest\x1a\x1a.memos.api.v1.ChatResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/api/v1/ai/chatB\xa6\x01\n" +
...
var file_api_v1_ai_service_proto_depIdxs = []int32{
	0, // 0: memos.api.v1.AiService.Chat:input_type -> memos.api.v1.ChatRequest
	1, // 1: memos.api.v1.AiService.Chat:output_type -> memos.api.v1.ChatResponse
